...
def plot_comparison(x1, y1, label1, x2, y2, label2, x_label, y_label, title, save_path,
    ...
    # --- ΕΠΑΝΑΦΟΡΑ: Βρόχος για ετικέτες (x,y) - Δεδομένα 1 ---
    ...
    # --- ΕΠΑΝΑΦΟΡΑ: Βρόχος για ετικέτες (x,y) - Δεδομένα 2 ---
